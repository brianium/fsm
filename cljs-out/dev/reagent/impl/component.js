...
var temp__5755__auto__ = p.argv;
if((temp__5755__auto__ == null)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,(function (){var G__14161 = p.children;
return reagent.impl.component.global$module$react.Children.toArray(G__14161);
})());
} else {
var v = temp__5755__auto__;
...
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__14163 = c;
var G__14163__$1 = (((G__14163 == null))?null:G__14163.prototype);
if((G__14163__$1 == null)){
return null;
} else {
return G__14163__$1.reagentRender;
}
})() == null)))));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__14165 = c;
var G__14165__$1 = (((G__14165 == null))?null:G__14165.prototype);
if((G__14165__$1 == null)){
return null;
} else {
return G__14165__$1.render;
}
})() == null)))));
});
...
var G__14175 = c;
var G__14175__$1 = (((G__14175 == null))?null:G__14175.constructor);
if((G__14175__$1 == null)){
return null;
} else {
return G__14175__$1.name;
}
}
});
...
var _STAR_current_component_STAR__orig_val__14176 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__14177 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__14177);

try{return reagent.impl.component.wrap_render(c,compiler);
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__14176);
}});
...
var c = this;
var G__14181_14183 = goog.object.get(c,"cljsRatom");
if((G__14181_14183 == null)){
} else {
reagent.ratom.dispose_BANG_(G__14181_14183);
}
...
var renders_14184 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$render,cljs.core.cst$kw$reagentRender], null));
var render_fun_14185 = cljs.core.first(cljs.core.vals(renders_14184));
...
if((cljs.core.count(renders_14184) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_14184))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_14185)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_14185], 0))].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var G__14186 = o;
goog.object.set(G__14186,cljs.core.name(k),v);
...
while (G__14188__i < G__14188__a.length) {G__14188__a[G__14188__i] = arguments[G__14188__i + 0]; ++G__14188__i;}
  args = new cljs.core.IndexedSeq(G__14188__a,0,null);
} 
...
var _STAR_current_component_STAR__orig_val__14192 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__14193 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__14193);

try{return reagent.impl.component.functional_wrap_render(compiler,c);
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__14192);
}});
...
var vec__14194 = reagent.impl.component.global$module$react.useState((0));
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14194,(0),null);
var update_count = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14194,(1),null);
...
var G__14197_14200 = (function reagent$impl$component$functional_render_$_mount(){
return (function reagent$impl$component$functional_render_$_mount_$_unmount(){
var G__14199 = goog.object.get(reagent_state,"cljsRatom");
if((G__14199 == null)){
return null;
} else {
return reagent.ratom.dispose_BANG_(G__14199);
}
});
});
var G__14198_14201 = [];
reagent.impl.component.global$module$react.useEffect(G__14197_14200,G__14198_14201);
