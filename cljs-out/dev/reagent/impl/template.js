...
var G__14214 = o;
goog.object.set(G__14214,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
while (G__14216__i < G__14216__a.length) {G__14216__a[G__14216__i] = arguments[G__14216__i + 0]; ++G__14216__i;}
  args = new cljs.core.IndexedSeq(G__14216__a,0,null);
} 
...
var G__14218 = o;
goog.object.set(G__14218,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
while (G__14220__i < G__14220__a.length) {G__14220__a[G__14220__i] = arguments[G__14220__i + 0]; ++G__14220__i;}
  args = new cljs.core.IndexedSeq(G__14220__a,0,null);
} 
...
var G__14222 = props;
var G__14222__$1 = (((((!((id == null)))) && ((cljs.core.cst$kw$id.cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__14222,cljs.core.cst$kw$id,id):G__14222);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__14222__$1,cljs.core.cst$kw$class,reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__4126__auto__ = cljs.core.cst$kw$class.cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__14223 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__14223,cljs.core.cst$kw$class,reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__14223;
}
})(),id_class);
...
var G__14224 = (cljs.core.count(argv) - first_child);
switch (G__14224) {
case (0):
...
break;
case (1):
var G__14225 = component;
var G__14226 = jsprops;
var G__14227 = reagent.impl.protocols.as_element(this$,cljs.core.nth.cljs$core$IFn$_invoke$arity$3(argv,first_child,null));
return reagent.impl.template.global$module$react.createElement(G__14225,G__14226,G__14227);
...
var vec__14229 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14229,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14229,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14229,(2),null);
...
var temp__5757__auto___14232 = reagent.impl.util.react_key_from_vec(v);
if((temp__5757__auto___14232 == null)){
} else {
var key_14233 = temp__5757__auto___14232;
(jsprops.key = key_14233);
}
...
var temp__5757__auto___14236 = reagent.impl.util.react_key_from_vec(v);
if((temp__5757__auto___14236 == null)){
} else {
var key_14237 = temp__5757__auto___14236;
(jsprops.key = key_14237);
}

var G__14234 = reagent.impl.component.functional_render_fn(compiler,tag);
var G__14235 = jsprops;
return reagent.impl.template.global$module$react.createElement(G__14234,G__14235);
});
/**
...
var temp__5757__auto___14238 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5757__auto___14238 == null)){
} else {
var key_14239 = temp__5757__auto___14238;
(jsprops.key = key_14239);
}
...
var temp__5757__auto___14240 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5757__auto___14240 == null)){
} else {
var key_14241 = temp__5757__auto___14240;
(jsprops.key = key_14241);
}
...
var temp__5757__auto___14242 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5757__auto___14242 == null)){
} else {
var key_14243 = temp__5757__auto___14242;
(jsprops.key = key_14243);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__14244_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__14244_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__14245 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14245,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14245,(1),null);
...
if((typeof reagent !== 'undefined') && (typeof reagent.impl !== 'undefined') && (typeof reagent.impl.template !== 'undefined') && (typeof reagent.impl.template.t_reagent$impl$template14255 !== 'undefined')){
} else {
...
*/
reagent.impl.template.t_reagent$impl$template14255 = (function (opts,id,fn_to_element,parse_fn,meta14256){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template14255.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_14257,meta14256__$1){
var self__ = this;
var _14257__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template14255(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta14256__$1));
}));

(reagent.impl.template.t_reagent$impl$template14255.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_14257){
var self__ = this;
var _14257__$1 = this;
return self__.meta14256;
}));

(reagent.impl.template.t_reagent$impl$template14255.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template14255.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template14255.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template14255.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template14255.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template14255.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$sym$opts,cljs.core.cst$sym$id,cljs.core.cst$sym$fn_DASH_to_DASH_element,cljs.core.cst$sym$parse_DASH_fn,cljs.core.cst$sym$meta14256], null);
}));

(reagent.impl.template.t_reagent$impl$template14255.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template14255.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template14255");

(reagent.impl.template.t_reagent$impl$template14255.cljs$lang$ctorPrWriter = (function (this__4369__auto__,writer__4370__auto__,opt__4371__auto__){
return cljs.core._write(writer__4370__auto__,"reagent.impl.template/t_reagent$impl$template14255");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template14255.
 */
reagent.impl.template.__GT_t_reagent$impl$template14255 = (function reagent$impl$template$create_compiler_$___GT_t_reagent$impl$template14255(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta14256){
return (new reagent.impl.template.t_reagent$impl$template14255(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta14256));
});

}

return (new reagent.impl.template.t_reagent$impl$template14255(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
