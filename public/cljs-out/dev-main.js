window.CLOSURE_UNCOMPILED_DEFINES = {"figwheel.repl.connect_url":"ws:\/\/localhost:9500\/figwheel-connect?fwprocess=608ae0&fwbuild=dev"};
...
document.write('<script>goog.require("fsm.dev");</script>');
