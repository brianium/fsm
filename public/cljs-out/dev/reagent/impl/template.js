...
var G__18886 = o;
goog.object.set(G__18886,reagent.impl.template.cached_prop_name.call(null,k),reagent.impl.template.convert_prop_value.call(null,v));
...
return (function() { 
var G__18887__delegate = function (args){
return cljs.core.apply.call(null,x,args);
};
var G__18887 = function (var_args){
var args = null;
...
while (G__18888__i < G__18888__a.length) {G__18888__a[G__18888__i] = arguments[G__18888__i + 0]; ++G__18888__i;}
  args = new cljs.core.IndexedSeq(G__18888__a,0,null);
} 
return G__18887__delegate.call(this,args);};
G__18887.cljs$lang$maxFixedArity = 0;
G__18887.cljs$lang$applyTo = (function (arglist__18889){
var args = cljs.core.seq(arglist__18889);
return G__18887__delegate(args);
});
...
var G__18890 = o;
goog.object.set(G__18890,reagent.impl.template.cached_custom_prop_name.call(null,k),reagent.impl.template.convert_prop_value.call(null,v));
...
while (G__18892__i < G__18892__a.length) {G__18892__a[G__18892__i] = arguments[G__18892__i + 0]; ++G__18892__i;}
  args = new cljs.core.IndexedSeq(G__18892__a,0,null);
} 
...
var args = cljs.core.seq(arglist__18893);
...
var G__18894 = props;
var G__18894__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.call(null,G__18894,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__18894);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.call(null,G__18894__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.call(null,class$,(function (){var or__4126__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class.call(null,(function (){var G__18895 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.call(null,G__18895,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.call(null,class$));
} else {
return G__18895;
}
})(),id_class);
...
var G__18896 = (cljs.core.count.call(null,argv) - first_child);
switch (G__18896) {
case (0):
...
var vec__18898 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__18898,(0),null);
var id = cljs.core.nth.call(null,vec__18898,(1),null);
var className = cljs.core.nth.call(null,vec__18898,(2),null);
...
var temp__5757__auto___18901 = reagent.impl.util.react_key_from_vec.call(null,v);
if((temp__5757__auto___18901 == null)){
} else {
var key_18902 = temp__5757__auto___18901;
(jsprops.key = key_18902);
}
...
var temp__5757__auto___18903 = reagent.impl.util.react_key_from_vec.call(null,v);
if((temp__5757__auto___18903 == null)){
} else {
var key_18904 = temp__5757__auto___18903;
(jsprops.key = key_18904);
}
...
var temp__5757__auto___18905 = reagent.impl.util.react_key_from_vec.call(null,argv);
if((temp__5757__auto___18905 == null)){
} else {
var key_18906 = temp__5757__auto___18905;
(jsprops.key = key_18906);
}
...
var temp__5757__auto___18907 = reagent.impl.util.get_react_key.call(null,cljs.core.meta.call(null,argv));
if((temp__5757__auto___18907 == null)){
} else {
var key_18908 = temp__5757__auto___18907;
(jsprops.key = key_18908);
}
...
var temp__5757__auto___18909 = reagent.impl.util.get_react_key.call(null,cljs.core.meta.call(null,argv));
if((temp__5757__auto___18909 == null)){
} else {
var key_18910 = temp__5757__auto___18909;
(jsprops.key = key_18910);
}
...
return cljs.core.into_array.call(null,cljs.core.map.call(null,(function (p1__18911_SHARP_){
return reagent.impl.protocols.as_element.call(null,compiler,p1__18911_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__18912 = reagent.ratom.check_derefs.call(null,(function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx,compiler);
}));
var res = cljs.core.nth.call(null,vec__18912,(0),null);
var derefed = cljs.core.nth.call(null,vec__18912,(1),null);
...
break;
default:
var G__18917 = cljs.core.with_meta.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,cljs.core.with_meta.call(null,v,null),(0),cljs.core.subs.call(null,n,(pos + (1))))], null),cljs.core.meta.call(null,v));
var G__18918 = compiler;
v = G__18917;
compiler = G__18918;
continue;
...
var G__18919 = tag;
var G__18919__$1 = (((G__18919 instanceof cljs.core.Keyword))?G__18919.fqn:null);
switch (G__18919__$1) {
case ">":
...
if((typeof reagent !== 'undefined') && (typeof reagent.impl !== 'undefined') && (typeof reagent.impl.template !== 'undefined') && (typeof reagent.impl.template.t_reagent$impl$template18922 !== 'undefined')){
} else {
...
*/
reagent.impl.template.t_reagent$impl$template18922 = (function (opts,id,fn_to_element,parse_fn,meta18923){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template18922.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_18924,meta18923__$1){
var self__ = this;
var _18924__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template18922(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta18923__$1));
}));

(reagent.impl.template.t_reagent$impl$template18922.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_18924){
var self__ = this;
var _18924__$1 = this;
return self__.meta18923;
}));

(reagent.impl.template.t_reagent$impl$template18922.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template18922.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template18922.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
return self__.parse_fn.call(null,this$__$1,tag_name,tag_value);
}));

(reagent.impl.template.t_reagent$impl$template18922.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element.call(null,this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template18922.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element.call(null,this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template18922.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta18923","meta18923",793995383,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template18922.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template18922.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template18922");

(reagent.impl.template.t_reagent$impl$template18922.cljs$lang$ctorPrWriter = (function (this__4369__auto__,writer__4370__auto__,opt__4371__auto__){
return cljs.core._write.call(null,writer__4370__auto__,"reagent.impl.template/t_reagent$impl$template18922");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template18922.
 */
reagent.impl.template.__GT_t_reagent$impl$template18922 = (function reagent$impl$template$create_compiler_$___GT_t_reagent$impl$template18922(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta18923){
return (new reagent.impl.template.t_reagent$impl$template18922(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta18923));
});

}

return (new reagent.impl.template.t_reagent$impl$template18922(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
