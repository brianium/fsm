...
var c_28015 = (new goog.debug.Console());
var G__28014_28016 = c_28015.getFormatter();
goog.object.set(G__28014_28016,"showAbsoluteTime",false);

goog.object.set(G__28014_28016,"showRelativeTime",false);


goog.object.set(goog.debug.Console,"instance",c_28015);
...
figwheel.repl.logging.log_levels = cljs.core.into.call(null,cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.call(null,cljs.core.juxt.call(null,clojure.string.lower_case,(function (p1__28017_SHARP_){
return goog.object.get(figwheel.repl.logging.LogLevel,p1__28017_SHARP_);
