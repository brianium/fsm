...
var o24475 = temp__5751__auto__;
var temp__5751__auto____$1 = (o24475["core"]);
if(cljs.core.truth_(temp__5751__auto____$1)){
var o24476 = temp__5751__auto____$1;
return (o24476["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__23479__auto__ = f;
return (o__23479__auto__["toString"]).call(o__23479__auto__);
} else {
return "";
}
}catch (e24477){var _ = e24477;
return "";
}});
...
try{var o__23479__auto___24479 = t;
(o__23479__auto___24479["cljs$lang$ctorPrWriter"]).call(o__23479__auto___24479,t,writer);
}catch (e24478){var __24480 = e24478;
}
...
var char_code = (function (){var o__23479__auto__ = (new String(char$));
return (o__23479__auto__["charCodeAt"]).call(o__23479__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__23479__auto__ = String;
return (o__23479__auto__["fromCharCode"]).call(o__23479__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__24481 = num_code;
switch (G__24481) {
case (1):
return (185);
...
var o__23479__auto__ = String;
return (o__23479__auto__["fromCharCode"]).call(o__23479__auto__,superscript_code);
});
/**
...
}catch (e24483){var _e__23486__auto__ = e24483;
return false;
}})())){
...
var vec__24484 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__24484,(0),null);
...
if(cljs.core.truth_(temp__5751__auto__)){
var o24487 = temp__5751__auto__;
var temp__5751__auto____$1 = (o24487["dependencies_"]);
if(cljs.core.truth_(temp__5751__auto____$1)){
var o24488 = temp__5751__auto____$1;
return (o24488["nameToPath"]);
} else {
return null;
}
} else {
...
var len__4736__auto___24495 = arguments.length;
var i__4737__auto___24496 = (0);
while(true){
if((i__4737__auto___24496 < len__4736__auto___24495)){
args__4742__auto__.push((arguments[i__4737__auto___24496]));

var G__24497 = (i__4737__auto___24496 + (1));
i__4737__auto___24496 = G__24497;
continue;
} else {
}
break;
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__24491){
var vec__24492 = p__24491;
var ns_detector = cljs.core.nth.call(null,vec__24492,(0),null);
...
var G__24498 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__24499 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__24498;
remaining_tokens = G__24499;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq24489){
...
var vec__24503 = cljs.core.split_with.call(null,(function (p1__24502_SHARP_){
return cljs.core.not_EQ_.call(null,p1__24502_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__24503,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__24503,(1),null);
...
var vec__24509 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__24509,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__24509,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__24512 = cljs.core.rest.call(null,remaining_tokens);
var G__24513 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__24512;
name_tokens = G__24513;
continue;
} else {
...
var vec__24516 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__24516,(0),null);
var arity = cljs.core.nth.call(null,vec__24516,(1),null);
var vec__24519 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__24519,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__24519,(1),null);
var vec__24522 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__24522,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__24522,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__24522,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__24522,(3),null);
...
var vec__24528 = result;
var munged_ns = cljs.core.nth.call(null,vec__24528,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__24528,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__24528,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__24528,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__24528,(4),null);
var arity = cljs.core.nth.call(null,vec__24528,(5),null);
...
if(cljs.core.truth_(temp__5751__auto__)){
var vec__24532 = temp__5751__auto__;
var munged_name = cljs.core.nth.call(null,vec__24532,(0),null);
var args = cljs.core.nth.call(null,vec__24532,(1),null);
var vec__24535 = devtools.munging.break_and_demunge_name.call(null,munged_name);
...
var G__24538 = (arity + (1));
var G__24539 = (function (){var temp__5751__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5751__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__24540){
var vec__24541 = p__24540;
var arity = cljs.core.nth.call(null,vec__24541,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__24541,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__24544_SHARP_){
return cljs.core.get.call(null,arities,p1__24544_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.call(null,devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.call(null,(function (p1__24545_SHARP_){
return cljs.core.drop.call(null,(2),p1__24545_SHARP_);
}),sorted_infos);
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__24548){
var vec__24549 = p__24548;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__24549,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq24546){
var G__24547 = cljs.core.first.call(null,seq24546);
var seq24546__$1 = cljs.core.next.call(null,seq24546);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__24547,seq24546__$1);
}));
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__24557__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__24557__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__24557__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__24557__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__24558 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__24558,(0),null);
var fn_name = cljs.core.nth.call(null,vec__24558,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__24558,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__24558,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__24558,(4),null);
var arity = cljs.core.nth.call(null,vec__24558,(5),null);
...
var o__23479__auto__ = f;
return (o__23479__auto__["getBasis"]).call(o__23479__auto__);
});
/**
...
}catch (e24562){var _e__23486__auto__ = e24562;
...
var G__24563 = (obj[cljs.core.first.call(null,path)]);
var G__24564 = cljs.core.rest.call(null,path);
obj = G__24563;
path = G__24564;
continue;
} else {
...
var _STAR_ = (function (accum,p__24565){
var vec__24566 = p__24565;
var bit = cljs.core.nth.call(null,vec__24566,(0),null);
var protocol = cljs.core.nth.call(null,vec__24566,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__24569){
var vec__24570 = p__24569;
var ns = cljs.core.nth.call(null,vec__24570,(0),null);
var name = cljs.core.nth.call(null,vec__24570,(1),null);
var selector = cljs.core.nth.call(null,vec__24570,(2),null);
...
var post_process = (function (p__24574){
var vec__24575 = p__24574;
var munged_name = cljs.core.nth.call(null,vec__24575,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__24575,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__24573_SHARP_){
return (obj[cljs.core.first.call(null,p1__24573_SHARP_)]);
}),sorted_matches);
