...
var line = cljs.core.get.call(null,map__29313__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__29313__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error.call(null,error.message,file,line,column);
}catch (e29312){var _e = e29312;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5751__auto___29315 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__5751__auto___29315)){
var seen_errors_29316 = temp__5751__auto___29315;
if(cljs.core.truth_(seen_errors_29316.has(self))){
} else {
seen_errors_29316.add(self);

var temp__5753__auto___29317 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__5753__auto___29317)){
var sense_29318 = temp__5753__auto___29317;
(self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_29318)].join(''));
} else {
}
}
} else {
