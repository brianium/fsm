...
var G__24598 = devtools.prefs.pref.call(null,v);
v = G__24598;
continue;
} else {
return v;
...
}catch (e24601){var _e__23486__auto__ = e24601;
return false;
}})();
...
}catch (e24605){var _e__23486__auto__ = e24605;
return false;
}})();
...
}catch (e24607){var _e__23486__auto__ = e24607;
return false;
}}
}
});
...
var vec__24609 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
...
return cljs.core.some.call(null,(function (p1__24612_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__24612_SHARP_);
}),template);
});
