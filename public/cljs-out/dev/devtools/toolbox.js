...
if((typeof devtools !== 'undefined') && (typeof devtools.toolbox !== 'undefined') && (typeof devtools.toolbox.t_devtools$toolbox28002 !== 'undefined')){
} else {
...
*/
devtools.toolbox.t_devtools$toolbox28002 = (function (obj,header,style,tag,meta28003){
this.obj = obj;
this.header = header;
this.style = style;
this.tag = tag;
...
(devtools.toolbox.t_devtools$toolbox28002.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_28004,meta28003__$1){
var self__ = this;
var _28004__$1 = this;
return (new devtools.toolbox.t_devtools$toolbox28002(self__.obj,self__.header,self__.style,self__.tag,meta28003__$1));
}));

(devtools.toolbox.t_devtools$toolbox28002.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_28004){
var self__ = this;
var _28004__$1 = this;
return self__.meta28003;
}));

(devtools.toolbox.t_devtools$toolbox28002.prototype.devtools$protocols$IFormat$ = cljs.core.PROTOCOL_SENTINEL);

(devtools.toolbox.t_devtools$toolbox28002.prototype.devtools$protocols$IFormat$_header$arity$1 = (function (_){
var self__ = this;
var ___$1 = this;
...
(devtools.toolbox.t_devtools$toolbox28002.prototype.devtools$protocols$IFormat$_has_body$arity$1 = (function (_){
var self__ = this;
var ___$1 = this;
return true;
}));

(devtools.toolbox.t_devtools$toolbox28002.prototype.devtools$protocols$IFormat$_body$arity$1 = (function (_){
var self__ = this;
var ___$1 = this;
...
(devtools.toolbox.t_devtools$toolbox28002.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"obj","obj",-1672671807,null),new cljs.core.Symbol(null,"header","header",1759972661,null),new cljs.core.Symbol(null,"style","style",1143888791,null),new cljs.core.Symbol(null,"tag","tag",350170304,null),new cljs.core.Symbol(null,"meta28003","meta28003",-493991456,null)], null);
}));

(devtools.toolbox.t_devtools$toolbox28002.cljs$lang$type = true);

(devtools.toolbox.t_devtools$toolbox28002.cljs$lang$ctorStr = "devtools.toolbox/t_devtools$toolbox28002");

(devtools.toolbox.t_devtools$toolbox28002.cljs$lang$ctorPrWriter = (function (this__4369__auto__,writer__4370__auto__,opt__4371__auto__){
return cljs.core._write.call(null,writer__4370__auto__,"devtools.toolbox/t_devtools$toolbox28002");
}));

/**
 * Positional factory function for devtools.toolbox/t_devtools$toolbox28002.
 */
devtools.toolbox.__GT_t_devtools$toolbox28002 = (function devtools$toolbox$__GT_t_devtools$toolbox28002(obj__$1,header__$1,style__$1,tag__$1,meta28003){
return (new devtools.toolbox.t_devtools$toolbox28002(obj__$1,header__$1,style__$1,tag__$1,meta28003));
});

}

return (new devtools.toolbox.t_devtools$toolbox28002(obj,header,style,tag,cljs.core.PersistentArrayMap.EMPTY));
}));
