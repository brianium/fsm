...
fsm.impl.add_effect.call(null,sm,key,fn_3);

return sm;
}));

(fsm.core.add_effect.cljs$core$IFn$_invoke$arity$5 = (function (sm,key,from,to,fn_3){
return fsm.impl.add_effect.call(null,sm,key,from,to,fn_3);
}));
...
fsm.impl.transition.call(null,sm,event,payload);

return sm;
}));

(fsm.core.transition.cljs$core$IFn$_invoke$arity$2 = (function (sm,event){
return fsm.impl.transition.call(null,sm,event);
}));
...
return fsm.impl.current_state.call(null,sm);
});
/**
...
return fsm.core.create_state_machine.call(null,states,initial_state,cljs.core.atom);
}));

(fsm.core.create_state_machine.cljs$core$IFn$_invoke$arity$3 = (function (states,initial_state,atom_fn){
return fsm.impl.create_state_machine.call(null,atom_fn.call(null,cljs.core.assoc.call(null,cljs.core.update.call(null,initial_state,new cljs.core.Keyword("fsm","state","fsm/state",-1988589875),new cljs.core.Keyword("fsm","state","fsm/state",-1988589875)),new cljs.core.Keyword("fsm","last-event","fsm/last-event",2067060890),null)),states);
}));
