...
return cljs.core.reduce.call(null,(function (result,p__27080){
...
var vec__27084 = clojure.data.diff.call(null,va,vb);
var a_STAR_ = cljs.core.nth.call(null,vec__27084,(0),null);
var b_STAR_ = cljs.core.nth.call(null,vec__27084,(1),null);
var ab = cljs.core.nth.call(null,vec__27084,(2),null);
...
var clojure$data$EqualityPartition$equality_partition$dyn_27090 = (function (x){
...
return clojure$data$EqualityPartition$equality_partition$dyn_27090.call(null,x);
}
});
...
var clojure$data$Diff$diff_similar$dyn_27091 = (function (a,b){
...
return clojure$data$Diff$diff_similar$dyn_27091.call(null,a,b);
}
});
...
return (function (){var G__27095 = clojure.data.equality_partition.call(null,a);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__27095__$1)].join('')));
